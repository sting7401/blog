...
import flowbite from 'flowbite/plugin'; // Flowbite 플러그인을 ES 모듈 방식으로 가져옴
import containerQueries from '@tailwindcss/container-queries'; // 컨테이너 쿼리 플러그인을 ES 모듈 방식으로 가져옴
import scrollbar from 'tailwind-scrollbar'; // 스크롤바 플러그인
import borderImage from 'tailwindcss-border-image'; // border-image 플러그인
...
export default {
	...
	plugins: [flowbite, containerQueries, scrollbar, borderImage, tailwindVectorEffect],
};
